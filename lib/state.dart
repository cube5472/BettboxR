...
class GlobalState {
  ...
  Future<Map<String, dynamic>> patchRawConfig({
    ...
    // без резолва — «VPN подключён, но ничего не работает». Гарантируем
    // РФ-доступные резолверы для ЛЮБОГО конфига, не только при overrideDns:
    // mihomo опрашивает nameserver параллельно и берёт первый ответивший,
    // так что добавка безвредна и вне РФ.
